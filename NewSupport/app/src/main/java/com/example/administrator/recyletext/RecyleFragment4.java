 ...
 * grid
 */
public class RecyleFragment4 extends Fragment {
    ...
    public class RecAdapter4 extends RecyclerView.Adapter<RecAdapter4.RecViewHodler> {

        List<String> data = new ArrayList<String>();
        int[] colors = new int[]{};
        int[] ress = new int[]{R.mipmap.image11, R.mipmap.image12, R.mipmap.image13, R.mipmap.image14};

        public RecAdapter4(List<String> list) {
            data = list;
        }
        ...
        public void onBindViewHolder(RecViewHodler recViewHodler, int i) {
            ...
            recViewHodler.mIv.setImageResource(ress[i % 3]);
        }
